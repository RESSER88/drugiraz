...
-- Create unique constraint to ensure only one primary key
CREATE UNIQUE INDEX idx_unique_primary_deepl_key ON public.deepl_api_keys(is_primary) WHERE is_primary = true;